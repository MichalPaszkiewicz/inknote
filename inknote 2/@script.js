...
(function (Inknote) {
    var Instrument = (function () {
        function Instrument(name) {
            this.name = name;
            this.bars = [];
            this.bars.push(new Inknote.Bar());
        }
        return Instrument;
    })();
    Inknote.Instrument = Instrument;
})(Inknote || (Inknote = {}));
var Inknote;
(function (Inknote) {
...
(function (Inknote) {
    ...
    Inknote.CompressedProject = CompressedProject;
})(Inknote || (Inknote = {}));
var Inknote;
(function (Inknote) {
    ...
    var Background = (function () {
        ...
        Background.prototype.draw = function (ctx, canvas, scale) {
            for (var i = 0; i < canvas.width; i += 4) {
                ...
                ctx.strokeStyle = Inknote.Colours.faintBlue;
                ctx.stroke();
            }
            this.t++;
            return true;
...
(function (Inknote) {
    var Stave = (function () {
        ...
        Stave.prototype.draw = function (ctx, canvas) {
            for (var i = 0; i < 5; i++) {
                ctx.beginPath();
                ctx.strokeStyle = Inknote.Colours.black;
...
(function (Inknote) {
    ...
    Inknote.LoadingSplash = LoadingSplash;
})(Inknote || (Inknote = {}));
var Inknote;
(function (Inknote) {
    var Name = (function () {
        function Name(name) {
            ...
            self.draw = function (ctx, canvas, scale) {
                if (self.select) {
                    ctx.beginPath();
                    ctx.fillStyle = Inknote.Colours.white;
                    ...
                    ctx.strokeStyle = Inknote.Colours.lightOrange;
                    ctx.lineWidth = 10;
                    ctx.stroke();
                    if (this.name.length > 0) {
                        ctx.beginPath();
                        ctx.fillStyle = Inknote.Colours.black;
                ...
                ctx.beginPath();
                ctx.fillStyle = Inknote.Colours.orange;
                ctx.font = "40px Arial";
                ctx.textAlign = "center";
...
(function (Inknote) {
    var KeyboardKey = (function () {
        ...
        KeyboardKey.prototype.draw = function (ctx, canvas) {
            ...
            grd.addColorStop(1, Inknote.Colours.white);
            ctx.fillStyle = grd;
            ctx.fill();
            ctx.beginPath();
            ctx.fillStyle = Inknote.Colours.black;
    ...
    Inknote.KeyboardKey = KeyboardKey;
    ...
    Inknote.keysFromString = keysFromString;
    ...
    Inknote.keysFromArray = keysFromArray;
})(Inknote || (Inknote = {}));
var Inknote;
(function (Inknote) {
        ...
        function Keyboard() {
            ...
            self.draw = function (ctx, canvas, scale) {
                if (canvas.width != self.cSize.x || canvas.height != self.cSize.y) {
                    ...
                    self.keys = [];
                    self.keys = self.keys.concat(Inknote.keysFromArray(["", "", "", "", "Delete"], 0, canvas.height / 2, canvas.width, canvas.height / 12));
                    self.keys = self.keys.concat(Inknote.keysFromString("qwertyuiop", 0, canvas.height / 2 + canvas.height / 12, canvas.width, canvas.height / 12));
                    self.keys = self.keys.concat(Inknote.keysFromString("asdfghjkl;", 0, canvas.height / 2 + 2 * canvas.height / 12, canvas.width, canvas.height / 12));
                    self.keys = self.keys.concat(Inknote.keysFromString("zxcvbnm,./", 0, canvas.height / 2 + 3 * canvas.height / 12, canvas.width, canvas.height / 12));
                    self.keys = self.keys.concat(Inknote.keysFromString(" ", 0, canvas.height / 2 + 4 * canvas.height / 12, canvas.width, canvas.height / 12));
                }
                else {
                }
                ctx.font = "12px Arial";
                ...
                grd.addColorStop(0, Inknote.Colours.darkestGray);
                grd.addColorStop(1, Inknote.Colours.darkerGray);
                ctx.fillStyle = grd;
...
(function (Inknote) {
    ...
    Inknote.BottomMenuButton = BottomMenuButton;
    ...
    Inknote.createMenuFromArray = createMenuFromArray;
})(Inknote || (Inknote = {}));
var Inknote;
(function (Inknote) {
        ...
        function BottomMenu() {
            ...
            self.draw = function (ctx, canvas, scale) {
                if (self.buttons.length < 1) {
                    self.buttons = Inknote.createMenuFromArray([
                        {
                            text: "Open",
                            click: function () {
...
(function (Inknote) {
    var DrawService = (function () {
        ...
        DrawService.prototype.arrange = function () {
            ...
            this.items.push(Inknote.Background.Instance);
        };
        return DrawService;
    })();
...
(function (Inknote) {
    ...
    (function (ProjectConverter) {
        var splash = new Inknote.LoadingSplash();
        var name = new Inknote.Name("");
        function toDrawing(drawer) {
            ...
            if (name.select) {
                items.push(Inknote.Keyboard.Instance);
            }
            items.push(name);
            items.push(new Inknote.Stave(180));
            if (project.pause) {
                items.push(splash);
            }
            return items;
        ...
        function compress(project) {
            var compressed = new Inknote.CompressedProject(project.name);
...
(function (Inknote) {
    ...
    (function (FileConverter) {
        ...
        function toDrawing(drawer) {
            ...
            for (var i = 0; i < projects.length; i++) {
                var file = new Inknote.File(projects[i].name);
            ...
            if (anySelected) {
                items.push(Inknote.BottomMenu.Instance);
            }
        ...
        CanvasControl.prototype.click = function (e) {
            ...
            for (var i = 0; i < allItems.length; i++) {
                if (Inknote.mouseIsOver(allItems[i], e, this.drawService.canvas)) {
                    ...
                    if (selectedID == Inknote.Keyboard.Instance.ID) {
                        Inknote.Keyboard.Instance.click(e);
                        return;
                    }
                    if (selectedID == Inknote.BottomMenu.Instance.ID) {
                        Inknote.BottomMenu.Instance.click(e);
                        return;
                    }
...
(function (Inknote) {
    var Main;
    (function (Main) {
        var settingsManager = Inknote.Managers.SettingsManager.Current;
        settingsManager.addSetting(new Inknote.Setting("Default"));
